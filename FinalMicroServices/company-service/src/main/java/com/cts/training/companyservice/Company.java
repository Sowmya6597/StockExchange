...
public class Company implements Serializable {
	...
	public Company(int id, String companyname, long turnover, String ceo, String bod, String[] lse, String sector,
			String boc, String stock, String companyCode) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Company [id=" + id + ", companyname=" + companyname + ", turnover=" + turnover + ", ceo=" + ceo
				+ ", bod=" + bod + ", lse=" + Arrays.toString(lse) + ", sector=" + sector + ", boc=" + boc + ", stock="
